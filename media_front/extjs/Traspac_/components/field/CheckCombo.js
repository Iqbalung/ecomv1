Ext.define('Traspac.components.field.CheckCombo',
{
    ...
    createPicker: function() 
    {
        var    me = this,
            ...
            opts = Ext.apply(
            {
                ...
                [
                    '<ul><tpl for=".">',
                        '<li role="option" class="' + Ext.baseCSSPrefix + 'boundlist-item '+ Ext.baseCSSPrefix + 'boundlist-itemx"><span class="x-combo-checker">&nbsp;</span> {' + me.displayField + '}</li>',
                    '</tpl></ul>'
                ]
    ...
    expand: function()
    {
        var    me = this,
            ...
            {
                me.allSelector = picker.getEl().down('.x-boundlist-list-ct').insertHtml('beforeBegin', '<div class="x-boundlist-itemx" role="option"><span class="x-combo-checker">&nbsp;</span> '+me.allText+'</div>', true);
