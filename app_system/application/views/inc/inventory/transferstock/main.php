...
<div class="container-fluid">
    ...
    <div class="page-title mb-4 d-flex align-items-center">
        <div class="mr-auto">
            <h4 class="weight500 d-inline-block pr-3 mr-3 border-right">Transferstock</h4>
            <nav aria-label="breadcrumb" class="d-inline-block ">
                <ol class="breadcrumb p-0">
                    <li class="breadcrumb-item"><a href="#">Transfer stock form warehouse Transaction</a></li>
                </ol>
            </nav>
        </div>
        <div class="row">
                            ...
                            <div class="row" style="padding: 10px;">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="exampleFormControlInput1">Reciepiet Number</label>
                                        <input type="text" class="form-control invoice-number" name="invoice_number">
                                        <label for="recipient-name" class="col-form-label">Warehouse from</label>
                                        <select class="form-control select2 warehouse" id="warehouse_from" name="warehouse_from">
                                        </select>
                                        <label for="recipient-name" class="col-form-label">Warehouse to</label><br>
                                        <select class="form-control select2 warehouse" id="warehouse_to" name="warehouse_from">
                                        </select>
                                        <br>
                                ...
                                <table id="data_tablex" class="table table-bordered table-striped" cellspacing="0">
                                    ...
                                    <tbody class="row-trx">
                                        <tr row="1">
                                            <td>1</td>
                                            <td>
                                                <select class="form-control input-sm select2 prod-id prod-id-1" id="prod-id" name="prod_id[]" style="width: 600px;">
                                                </select>
                                            </td>
                                            <td><input type="text" class="form-control field-calc input-sm prod_stock prod_stock-1" prod_stock="1" name="prod_stock[]"></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </form>
...
<script type="text/javascript" src="<?php echo config_item('url_app') ?>js/modules/inventory/transferstock.js"></script>