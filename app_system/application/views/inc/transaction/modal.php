          ...
          <div class="modal-body">
              <form class="form-detail-transaction">
                      ...
                      <div class="form-group list-state-trx">
                        <label>Status</label>
                          <ul>
                            <li>
                              <div>
                                  <input readonly type="checkbox" order="1" name="pending" class="iCheck field-state" >
                                  <label class="  control-label">PENDING</label>
                              </div>
                            </li>
                            <li>
                              <div>
                                  <input readonly type="checkbox" order="1" name="ready_to_package" class="iCheck field-state" >
                                  <label class="  control-label">READY TO PACKAGE</label>
                              </div>
                            </li>
                            <li>
                              <div>
                                  <input readonly type="checkbox" order="2" name="ready_to_ship" class="iCheck field-state" >
                                  <label class="control-label">READY TO SHIP</label>
                              </div>
                            </li>
                            <li>
                              <div>
                                  <input readonly type="checkbox" order="3" name="shipped" class="iCheck field-state" >
                                  <label class="control-label">SHIPPED</label>
                              </div>
                            </li>
                            <li>
                              <div>
                                  <input readonly type="checkbox" order="4" name="delivered" class="iCheck field-state" >
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group group-ref-field-state field-state-shipped hidden">
                        <label for="message-text" class="col-form-label">Courier</label><br>
                        <select class="form-control ref-field-state js-example-basic-single select2" name="trx_courier" style="width: 100%;">
