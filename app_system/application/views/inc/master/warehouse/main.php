					...
					<div class="col-md-7">				
			            ...
			            <nav aria-label="breadcrumb" class="d-inline-block ">
			                <ol class="breadcrumb p-0">
			                    <li class="breadcrumb-item"><a href="#">Manage Warehouse</a></li>
			                </ol>
			            </nav>	
					</div>
...
<script type="text/javascript" src="<?php echo config_item('url_app') ?>js/modules/master/warehouse/main.js"></script>