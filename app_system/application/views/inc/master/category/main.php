	...
	<div class="page-master col-md-12">
		<div class="pg-header">
			<div class="col-md-12">
				<div class="row">				
					<div class="col-md-7">
						<h4 class="weight500 d-inline-block pr-3 mr-3 border-right">Category</h4>
			            <nav aria-label="breadcrumb" class="d-inline-block ">
			                <ol class="breadcrumb p-0">
			                    <li class="breadcrumb-item"><a href="#">Manage Category Product</a></li>
			                </ol>
			            </nav>				
					...
					<div class="col-md-1 padding-5">
						<button class="btn btn-default btn-success btn-flat btn-box bg-green" id="btn-add-category"><i class="fa fa-plus"></i></button>
					</div>
				</div>
			</div>
		</div>
		<div class="col-md-12" style="margin-top: 20px;">
			<div class="pg-content col-md-12">
				<table id="table-category" class="display table-action" style="width:100%">
			        <thead>
			            <tr>
			            	<th width="60">No</th>
			                <th>Name</th>
...
<?php $this->view("inc/master/category/modal"); ?>

<script type="text/javascript" src="<?php echo config_item('url_app') ?>js/modules/master/category/main.js"></script>