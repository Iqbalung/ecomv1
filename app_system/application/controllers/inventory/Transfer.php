...
class Transfer extends MY_Controller {
	...
	public function index()
	{
		...
		$this->template->display('inc/inventory/transferstock/main', $data);
	}
	...
	public function search_product()
	{
		$params = array(
			...
			"where_search" => array("prod_name","prod_code")
		);
	...
	public function save(){
		...
		$params = array(
			...
			"buy_datecreated" =>  date('m-d-Y', strtotime(str_replace('/', '-', ifunsetempty($method, 'buy_date', '01-01-1950')))),
