						...
						else
						{
							...
							result.data.forEach(function(row) {
								var trx_type = {
									...
									state = `								
								<a class="btn btn-sm btn-info btn-pill pl-2 pr-2 btn-action-workin">Work In</a>
								...
								<div class="btn-group">
				                  ...
				                  <div class="dropdown-menu  grup-btn-action-close">
				                      ...
				                      <a class="dropdown-item btn-action-close" flag="out_of_stock" href="`+app.data.site_url +`/cetak/shipping_label/`+ row.trx_id + `">Shipping Label</a>                      
				                      <a class="dropdown-item btn-action-close" flag="out_of_stock" href="`+app.data.site_url +`/cetak/surat_jalan/`+ row.trx_id + `">Surat Jalan</a>                      
				                  </div>
				              </div>
								`;
								...
								var content = `
									<tr>
	                                    ...
	                                    <td>
	                                      ` + trx_type[app.ifvalnull(row.trx_type,"n")]  + `
	                                    </td>
	                                    <td width="300">
	                                        ` + row.mos_name + `
	                                    </td>
