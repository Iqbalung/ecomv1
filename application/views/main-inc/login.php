	      ...
	      <div class="row">
	        <div class="col-md-5 bg-form pull-right" style="">
	          <div class="col-xs-12 text-center" style="margin-bottom: 20px;">
	          	...
	          	<div class="text-center" style="color: #AEB6B9; text-transform: uppercase; font-weight: bold; font-size: 20px; line-height: 100%; margin-bottom: 10px;"><?php echo config_item('app_longname') ?></div>
