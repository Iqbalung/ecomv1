$(document).ready(function() {
	cart = {
		...
		load_list:function(is_load) {
			...
			app.body_mask();
				$.ajax({
					url: app.data.site_url + '/transaction/app/get_trx_total',
					type: 'GET',
					dataType: 'json',
					data: params,
				})
				.done(function(result) {
					...
					$('#invoice_id').text(result.invoice_id);
					$('#kode_unik').text(result.kode_unik);
					$('.total_dibayar').text(result.total_dibayar);
				})
