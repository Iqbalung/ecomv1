$(document).ready(function() {
	cart = {
		...
		init: function() {
			...
			cart.selected.shipping = JSON.parse($(".src-courier.chosen").val());
			console.log(cart.selected.shipping);
			  	var content2 = `
					<tr class="data-kosong courier-row">
                        <td class="col-md-12" align="left">Pengiriman (`+cart.selected.shipping.description+`)</td>
                        <td class="col-md-12" align="center"></td>
                        <td class="col-md-12" align="center"></td>
                        <td class="col-md-12" align="right">`+cart.selected.shipping.cost[0].value+`</td>
                    </tr>
		...
		listeners: function() {
			...
			$('[aria-label="Page navigation"]').delegate('.pagination a', 'click', function(event) {
				event.preventDefault();
				cart.start = $(this).attr('data-ci-pagination-page');
				me.load_list();
			});	
					...
					if ("data" in result)
					{
						...
						else
						{
							...
							result.data.forEach(function(row) {
								...
								var content = `
								<tr class="data-kosong">
		                            <td class="col-md-12" align="left">`+row.name+`</td>
		                            <td class="col-md-12" align="center">`+row.price+`</td>
		                            <td class="col-md-12" align="center">`+row.qty+`</td>
		                            <td class="col-md-12" align="right">`+row.subtotal+`</td>
		                        </tr>
								
								`;
								$('#shopping-table').append(content);
								$('#shopping-table').data(row);
								no++;
							});
							cart.selected.sum = sum;
							var content2 = `
								<tr class="data-kosong">
		                            <td class="col-md-12" align="left">Total</td>
		                            <td class="col-md-12" align="center"></td>
		                            <td class="col-md-12" align="center"></td>
		                            <td class="col-md-12" align="center">`+sum+`</td>
		                        </tr>
