...
<div class="container-fluid">
    ...
    <div class="page-title mb-4 d-flex align-items-center">
        <div class="mr-auto">
            <h4 class="weight500 d-inline-block pr-3 mr-3 border-right">Purchase</h4>
            <nav aria-label="breadcrumb" class="d-inline-block ">
                <ol class="breadcrumb p-0">
                    <li class="breadcrumb-item"><a href="#">Add Prucahase Transaction</a></li>
                </ol>
            </nav>
        </div>
        <div class="row">
...
<script type="text/javascript" src="<?php echo config_item('url_app') ?>js/modules/inventory/purchase.js"></script>