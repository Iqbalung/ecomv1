	...
	<div class="page-master col-md-12">
			...
			<div class="col-md-12">
				<div class="row">				
					<div class="col-md-7">				
			            ...
			            <nav aria-label="breadcrumb" class="d-inline-block ">
			                <ol class="breadcrumb p-0">
			                    <li class="breadcrumb-item"><a href="#">Manage Supplier Product</a></li>
			                </ol>
			            </nav>	
					</div>
					...
					<div class="col-md-1 padding-5">
						<button class="btn btn-default btn-success btn-flat btn-box bg-green" id="btn-add-suplier"><i class="fa fa-plus"></i></button>
					</div>
				</div>
			</div>
		</div>
		<div class="col-md-12" style="margin-top: 20px;">
			<div class="pg-content col-md-12">
				<table id="table-suplier" class="display table-action" style="width:100%">
			        <thead>
			            <tr>
			            	<th width="60">No</th>
			                <th>Name</th>
...
<?php $this->view("inc/master/suplier/modal"); ?>

<script type="text/javascript" src="<?php echo config_item('url_app') ?>js/modules/master/suplier/main.js"></script>